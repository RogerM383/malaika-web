            ...
            <div className={"container content"}>
                ...
                <div className={"row"}>
                    ...
                    <div className={"column"}>
                        <p className={"bold"}>Las Vegas has more than 100,000 hotel rooms to choose from. There is something for every budget, and enough entertainment within walking distance to keep anyone occupied for months, never mind the usual weekend stay or honeymoon.</p>
                    </div>
                </div>
